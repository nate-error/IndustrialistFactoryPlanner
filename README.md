...
Scrape.py (currently the main for the python scrapper) should work as intended, modify the "HEADERS" var in fetch.py to not use the default config of the UserAgent. It caches the pages data that it fetches and are sent in "./cache". The json output is sent to "./Data".
